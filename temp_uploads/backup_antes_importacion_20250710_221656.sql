...
INSERT INTO `tb_articulo` (`i_id`, `a_c_contable`, `a_stockMax`, `a_stockMin`, `created_at`, `updated_at`) VALUES (1,'000000',100,5,'2025-07-11 03:13:14','2025-07-11 03:13:14');
...
CREATE TABLE `tb_item` (
  ...
  `i_serial` varchar(100) DEFAULT NULL,
  `i_codigo_identificacion` varchar(100) DEFAULT NULL,
  `i_estado` varchar(20) DEFAULT NULL,
  `i_observaciones_estado` varchar(500) DEFAULT NULL,
  `id` int NOT NULL AUTO_INCREMENT,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `tb_item` (`i_codigo`, `i_nombre`, `i_tipo`, `i_cantidad`, `i_vUnitario`, `i_vTotal`, `i_serial`, `i_codigo_identificacion`, `i_estado`, `i_observaciones_estado`, `id`, `created_at`, `updated_at`) VALUES ('ART001','laptop hp pavilion','articulo',2,1.00,2.00,'683bhdsbsyf2873',NULL,'Baja',NULL,1,'2025-07-11 03:13:14','2025-07-11 03:13:43');
...
INSERT INTO `tb_movimiento_detalle` (`m_fecha`, `m_tipo`, `m_cantidad`, `m_valorUnitario`, `m_valorTotal`, `m_observaciones`, `m_stock_anterior`, `m_stock_actual`, `m_valor_anterior`, `m_valor_actual`, `i_id`, `e_id`, `c_id`, `u_id`, `id`, `created_at`, `updated_at`) VALUES ('2025-07-10 00:00:00','entrada',1,1.00,1.00,'Stock inicial del artículo ART001',NULL,NULL,NULL,NULL,1,NULL,NULL,1,1,'2025-07-11 03:13:14','2025-07-11 03:13:14'),('2025-07-10 22:13:14','entrada',1,1.00,1.00,'Entrada inicial - DONACIÓN - 000000 [DONACIÓN] - mm',NULL,NULL,NULL,NULL,1,NULL,NULL,1,2,'2025-07-11 03:13:14','2025-07-11 03:13:14');
...
CREATE TABLE `tb_usuario` (
  ...
  `u_codigo_dactilar` varchar(255) DEFAULT NULL,
  `id` int NOT NULL AUTO_INCREMENT,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `tb_usuario` (`u_username`, `u_password`, `u_codigo_dactilar`, `id`, `created_at`, `updated_at`) VALUES ('admin','pbkdf2:sha256:600000$3P1KXnWWA0Yk4pjp$9ac43e2e135637bd865a4e67318589788ce178da3fb348caef4f8bffee6e2cd6','pbkdf2:sha256:600000$vxtDNiNSd2xjAGdg$050756b2b8518c89116b30e22e174aceec90914b2a4a19c6ebc3433e7a9cdbd4',1,'2025-07-11 03:11:02','2025-07-11 03:11:23');
...
-- Dump completed on 2025-07-10 22:16:56
